...
<div class="container mt-5 p-5" style="padding-bottom: 200px">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="lessonSelect">
            <option value="lesson2">Lesson 2 - body parts</option>
            <option value="lesson3">Lesson 3 - school supplies...</option>
            <option value="lesson4">Lesson 4 - adjectives</option>
            <option value="lesson5">Lesson 5 - hobbies</option>
            <option value="lesson6">Lesson 6 - food</option>
            <option value="lesson7">Lesson 7 - daily routine</option>
            <option value="lesson8">Lesson 8 - clothes</option>
            <option value="lesson9">Lesson 9 - phrasal verbs</option>
            <option value="lesson10">Lesson 10 - animals</option>
            <option value="lesson11">Lesson 11 - places</option>
            <option value="lesson12">Lesson 12 - sickness</option>
            <option value="lesson13">Lesson 13 - family/job</option>
        </select>
    </div>
